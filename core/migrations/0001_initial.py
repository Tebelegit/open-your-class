    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, null=True, unique=True)),
                ('name', models.CharField(max_length=150)),
                ('description', models.TextField(help_text='présentation globale du chapitre (objectifs, contexte)')),
                ('video_file', models.FileField(blank=True, null=True, upload_to='chapters/videos/%Y/%m/%d/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp4', 'mkv'], message='erreur. formats autorisés : .mp4, .mkv')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(help_text='Contenu ciblé : un concept précis, pas de répétition du chapitre')),
                ('order', models.PositiveIntegerField(default=1)),
